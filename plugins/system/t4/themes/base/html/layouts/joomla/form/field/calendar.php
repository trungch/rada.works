...
if(empty($calendar)) $calendar = JFactory::getLanguage()->getCalendar();
if(empty($firstday)) $firstday = JFactory::getLanguage()->getFirstDay();
$jweekend = JFactory::getLanguage()->getWeekEnd();
$calendarAttrs = [
	'data-inputfield'      => $id,
	'data-button'          => $id . '_btn',
